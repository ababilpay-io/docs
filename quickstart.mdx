...
<CardGroup cols={2}>
  ...
  <Card title="Shopify and WooCommerce" icon="terminal" href="/commerce#e-commerce-payment-suite">
    Use hosted commerce plugins instead of a direct API integration.
  </Card>
  <Card title="Transfers" icon="code" href="/api-reference/introduction">
    Send USDC to a wallet address or email recipient.
  </Card>
  <Card title="Webhooks" icon="recycle" href="/api-reference/introduction">
